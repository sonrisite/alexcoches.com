    ...
    <div className="min-h-screen bg-black">
      ...
      <section id="catalogo" className="py-6 md:py-8 bg-zinc-50 relative min-h-screen">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <div className="bg-white p-2 md:p-2.5 rounded-2xl shadow-xl border border-zinc-100 -mt-8 md:-mt-10 mb-6 md:mb-8 relative z-20 max-w-3xl mx-auto transition-all duration-300">
